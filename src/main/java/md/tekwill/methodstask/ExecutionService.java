...
public class ExecutionService {
    public static void main(String[] args) {
        ...
        System.out.println("Random Email 2: " + DataGeneratorUtil.getRandomEmail("anastasia", "@gmail.com"));
        ...
        Customer customer001 = new Customer("Vladislav", DataGeneratorUtil.getRandomInt(18, 100), "vladislav@gmail.com");
        customer001.setName("Felix");
        customer001.setEmail("felixotis@gmail.com");
        ...
        Customer customer002 = new Customer("Vladislav", DataGeneratorUtil.getRandomInt(18, 100), "vladislav@gmail.com");
        ...
        System.out.println((DataGeneratorUtil.getRandomEmail("alex+", "@gmail.com")));
        ...
        randomDataCustomer.setEmail(DataGeneratorUtil.getRandomEmail("anastasia", "@yahoo.com"));
        System.out.println(randomDataCustomer.getTheObjectInformation());
    }
}
