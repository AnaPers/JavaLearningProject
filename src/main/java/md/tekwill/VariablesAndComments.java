...
public class VariablesAndComments {
    ...
    public static void main(String[] args) {
      ...
      //Declare section
        ...
        byte lowerLimitOfByteDatType;
        byte upperLimitOfByteDatType;
        ...
        float upperLimitOfFloatDatType;
        double loweLimitOfDoubleDataType;
        ...
        upperLimitOfFloatDatType = 3.4E+38F;
        loweLimitOfDoubleDataType = -1.7E+308d;
